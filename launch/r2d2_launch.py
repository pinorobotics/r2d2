...
def generate_launch_description():
  ...
  #print(sorted(moveit_config.to_dict().items()))
  ...
  return LaunchDescription([
      ...
      Node(
        ...
        # Required for Interactive Markers to be available in RViz MotionPlanning plugin
        # https://wiki.ros.org/rviz/Tutorials/Interactive%20Markers%3A%20Getting%20Started
        parameters=[
